package com.xtxk.recognition.prepare.service.aspect;

import cn.hutool.json.JSONUtil;
import cn.hutool.log.Log;
import com.xtxk.recognition.prepare.service.web.AlarmInfoController;
...
public class LogAspect {
    ...
    @Pointcut("@within(com.xtxk.recognition.prepare.service.component.annotation.AspectLogger) || @annotation( com.xtxk.recognition.prepare.service.component.annotation.AspectLogger)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws NoSuchMethodException {
        ...
        if (filterArgs.size()>0 && parameters.length>0) {
            ...
            LOGGER.info("请求入参=>MethodName:{},参数;{}.",methodName, JSONUtil.toJsonStr(paramMap));
        }
        try {
            // 执行原方法
            data = joinPoint.proceed(args);
        } catch (Throwable throwable) {
            LOGGER.error("执行出错,方法名：{},参数;{}.",methodName,throwable.getMessage() );
            throwable.printStackTrace();
        }
        if (data != null) {
            LOGGER.info("请求出参====>MethodName:{},参数;{}.",methodName, JSONUtil.toJsonStr(data));
        }
        return data;
    }
}